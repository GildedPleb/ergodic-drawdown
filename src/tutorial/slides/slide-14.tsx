...
const Slide14: FC = () => (
  <SlideContent>
    ...
    <p>
      ...
      modal, change Currency to BTC and Amount Today to 1, then Save. Notice how
      the quantiles collapse since it's now in bitcoin.
    </p>
    <p>
      Try unchecking "Expense" to see it as an acquisition. Switch back to
      $10,000,000 USD to view the upside spread.
    </p>
    <p>
